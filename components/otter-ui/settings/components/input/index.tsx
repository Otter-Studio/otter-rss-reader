...
const settingsInputContainer = tva({
...
export const SettingsInput: React.FC<SettingsSwitchProps> = ({
  label,
  tips,
  value,
  onChange,
  ...
  return (
    <FormControl>
      ...
      <HStack className={settingsInputContainer({ type })}>
        <Text className={settingsInputLabel({ type })}>{label}</Text>
